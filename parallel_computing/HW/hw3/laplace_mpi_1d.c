...
#define EXTRAROWS  (ROWS_GLOBAL%NPES) // extra rows
...
// double **Temperature = malloc((my_rows + 2)) * sizeof(double *));
// for (int i=0; i < my_rows)
...
int main(int argc, char *argv[]) {
    ...
    int rows_per_process = ROWS_GLOBAL / npes; // Calculate local dimensions
